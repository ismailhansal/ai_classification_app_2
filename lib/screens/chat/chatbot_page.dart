...
class ChatbotPage extends StatefulWidget {
  const ChatbotPage({super.key, required this.section, this.showAppBar = true});
        ...
        setState(() {
          _messages.add(
            _ChatMessage(
              ...
              text: "${widget.section} bot: I received your message.",
            ),
          );
        });
        unawaited(_scrollToBottom());
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        "Start chatting with ${widget.section}. You can also attach an image or document.",
