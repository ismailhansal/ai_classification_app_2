...
class LstmChatbotPage extends StatefulWidget {
  const LstmChatbotPage({super.key, this.showAppBar = true});

  final bool showAppBar;

  @override
  State<LstmChatbotPage> createState() => _LstmChatbotPageState();
}

class _LstmChatbotPageState extends State<LstmChatbotPage> {
        ...
        setState(() {
          _messages.add(
            _ChatMessage(
              ...
              text: "LSTM bot: I received your message.",
            ),
          );
        });
        unawaited(_scrollToBottom());
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        "Start chatting with LSTM. You can also attach an image or document.",
